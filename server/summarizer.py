...
def authenticate_client():
    key = os.environ["AZURE_COGNITIVE_KEY"]  # Use the name of the environment variable, not its value
    endpoint = os.environ["AZURE_COGNITIVE_ENDPOINT"]  # Use the name of the environment variable, not its value
